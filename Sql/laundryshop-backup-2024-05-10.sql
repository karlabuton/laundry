...
-- Date: Fri, 10 May 2024 08:52:03 +0000
...
-- Dumped table `customer` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `request` VALUES (23,'2024-05-09 16:00:00','White only ','pending','pending',7,0,'180','K003',16,13);
/*!40000 ALTER TABLE `request` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `request` with 1 row(s)
--
...
-- Dumped table `status` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `user` VALUES (1,'Administrator','admin','1234','superuser',0,''),(7,'Staff','karla','1234',NULL,0,'K002'),(8,'Customer','leng','1234',NULL,7,''),(9,'Staff','simone','1234',NULL,0,'K003');
...
-- Dump completed on: Fri, 10 May 2024 08:52:03 +0000
