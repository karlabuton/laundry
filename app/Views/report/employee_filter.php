        ...
        <div class="card-body">
            <form action="<?= base_url() ?>ReportController/report_filter" method="post">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="form-group">
                            <a target="blank" href="<?php echo base_url() . 'ReportController/print_emp/' . set_value('start_date') . '/' . set_value('end_date') ?>" class="btn btn-success btn-block rounded-0 shadow-sm"><i class="fas fa-print fa-sm text-white-500"></i> Print</a>
                        </div>
                    </div>
                </div>
            </form>
