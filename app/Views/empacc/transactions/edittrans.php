                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold  mx-3 mt-3" id="formEdittransactionLabel">Edit Transaction Data</h5>
                            ...
                            <div class="modal-body"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="employee_id" required>
                                        ...
                                        ?>
                                        <option value="<?php echo $employee->employee_id ?>" <?php if ($employee->employee_id === $transaction->employee_id) { echo "selected"; } ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"  class="form-control" placeholder='Laundry Order Date' name="date_order" value="<?php echo $transaction->date_order ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"  class="form-control" placeholder='Finished Date' name="date_finish" value="<?php echo $transaction->date_finish ?>">
                                </div>
                            </div>
