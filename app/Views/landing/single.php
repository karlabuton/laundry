                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="<?= base_url() ?>LandingController/landingblog" class="dropdown-item">Blog Grid</a>
                                <a href="<?= base_url() ?>LandingController/single" class="dropdown-item active">Blog Detail</a>
                            </div>
                        </div>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <img class="img-fluid w-100 mb-4" src="<?= base_url() ?>public/landing/img/carousel-1.jpg" alt="Image">
                    ...
                    <img class="img-fluid w-50 float-left mr-4 mb-3" src="<?= base_url() ?>public/landing/img/blog-1.jpg" alt="Image">
                    ...
                    <img class="img-fluid w-50 float-right ml-4 mb-3" src="<?= base_url() ?>public/landing/img/blog-2.jpg" alt="Image">
                ...
                <div class="mb-5">
                    ...
                    <div class="media mb-4">
                        <img src="<?= base_url() ?>public/landing/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0">
                ...
                <div class="d-flex flex-column text-center bg-secondary mb-5 py-5 px-4">
                    <img class="rounded-circle bg-white shadow mx-auto mb-4" src="<?= base_url() ?>public/landing/img/user.jpg" style="width: 100px; height: 100px; padding: 12px;" alt="">
                ...
                <!-- Image Start -->
                <div class="mb-5">
                    <img src="<?= base_url() ?>public/landing/img/blog-1.jpg" alt="" class="img-fluid">
                </div>
                <!-- Image End -->
