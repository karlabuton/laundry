            ...
            <footer class="sticky-footer bg-white shadow border py-3">
                <div class="container-fluid my-auto">
                    <div class="copyright text-center my-1 d-flex justify-content-between">
                        <div class="col-auto"><b>Developed by: Comscie Students</b>  'CodeIgniter Version : Abuton Lomoljo Ganados</div>
                        <div class="col-auto"><span>&copy; Laundry Management System - <?//php echo date('Y')?> Version 1.0</span></div>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
