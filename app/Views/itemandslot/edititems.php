...
<?php foreach ($data_items as $items) { ?>
    <div class="modal fade" id="editcustomer_<?php echo $items->itemandslot_id ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="formEditcustomer" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>ItemandslotController/edititems/<?= $items->itemandslot_id ?>" method="post" class="user needs-validation mx-3 mb-4" novalidate>
