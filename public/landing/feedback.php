            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="bg-light text-center p-4 pt-0">';
                        echo '<h5 class="font-weight-medium mt-5">' . $row["customer_name"] . '</h5>';
                        echo '<p class="text-muted font-italic">Profession</p>';
