...
<div class="container-fluid py-5">
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel">
            ...
            $sql = "SELECT customer_name, description FROM tbl_feedback";
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <div class="testimonial-item">
                        <div class="bg-light text-center p-4 pt-0">
                            <h5 class="font-weight-medium mt-5"><?php echo $row["customer_name"]; ?></h5>
                            <!-- Assuming you want to display profession, replace 'Profession' with the column name from your database -->
                            <p class="text-muted font-italic"><?php echo $row["profession"]; ?></p>
